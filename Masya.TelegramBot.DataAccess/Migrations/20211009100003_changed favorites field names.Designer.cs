...
namespace Masya.TelegramBot.DataAccess.Migrations
{
    ...
    [Migration("20211009100003_changed favorites field names")]
    partial class changedfavoritesfieldnames
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryUserSettings", b =>
                {
                    ...
                    b.HasKey("SelectedCategoriesId", "UserSettingsId");

                    b.HasIndex("UserSettingsId");

                    b.ToTable("CategoryUserSettings");
                });

            modelBuilder.Entity("DirectoryItemUserSettings", b =>
                {
                    b.Property<int>("SelectedRegionsId")
                        .HasColumnType("int");

                    b.Property<long>("UserSettingsId")
                        .HasColumnType("bigint");

                    b.HasKey("SelectedRegionsId", "UserSettingsId");

                    b.HasIndex("UserSettingsId");

                    b.ToTable("DirectoryItemUserSettings");
                });
            ...
            modelBuilder.Entity("Masya.TelegramBot.DataAccess.Models.Image", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Masya.TelegramBot.DataAccess.Models.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoomUserSettings", b =>
                {
                    ...
                    b.HasKey("RoomsId", "UserSettingsId");

                    b.HasIndex("UserSettingsId");

                    b.ToTable("RoomUserSettings");
                });

            modelBuilder.Entity("CategoryUserSettings", b =>
                {
                    b.HasOne("Masya.TelegramBot.DataAccess.Models.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DirectoryItemUserSettings", b =>
                {
                    b.HasOne("Masya.TelegramBot.DataAccess.Models.DirectoryItem", null)
                        .WithMany()
                        .HasForeignKey("SelectedRegionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Masya.TelegramBot.DataAccess.Models.Favorites", b =>
                {
                    b.HasOne("Masya.TelegramBot.DataAccess.Models.RealtyObject", "RealtyObject")
                        .WithMany()
            ...
            modelBuilder.Entity("Masya.TelegramBot.DataAccess.Models.Image", b =>
                {
                    b.HasOne("Masya.TelegramBot.DataAccess.Models.RealtyObject", null)
                        .WithMany("Images")
                        .HasForeignKey("RealtyObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Masya.TelegramBot.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasOne("Masya.TelegramBot.DataAccess.Models.UserSettings", "UserSettings")
                        .WithOne("User")
                        .HasForeignKey("Masya.TelegramBot.DataAccess.Models.User", "UserSettingsId");
            ...
            modelBuilder.Entity("RoomUserSettings", b =>
                {
                    b.HasOne("Masya.TelegramBot.DataAccess.Models.Room", null)
                        .WithMany()
