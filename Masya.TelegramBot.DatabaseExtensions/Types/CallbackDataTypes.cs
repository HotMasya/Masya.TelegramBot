...
namespace Masya.TelegramBot.DatabaseExtensions.Types
{
    ...
    {
        public const string MainMenu = "__SEARCH_MENU__";
        public const string ExecuteSearch = "__SEARCH_EXECUTE__";
        public const string ChangeSettings = "__SEARCH_SETTINGS__";

        public const string UpdateCategories = "__SEARCH_SETTINGS_CATEGORIES__";
        public const string UpdateRegions = "__SEARCH_SETTINGS_REGIONS__";
